...
export default function HistoryModal({
 ...
 className="relative w-full max-w-md bg-white rounded-[32px] overflow-hidden flex flex-col max-h-[80vh]"
 >
 ...
 filterType === "all" ? "bg-slate-800 text-white " : "bg-slate-100 text-slate-500"
 )}
 >
 전체
 </button>
 ...
 className={cn(
 "flex-1 py-2.5 rounded-xl text-sm font-bold transition-all",
 filterType === "pay" ? "bg-slate-800 text-white " : "bg-slate-100 text-slate-500"
 )}
 >
 결제
 </button>
