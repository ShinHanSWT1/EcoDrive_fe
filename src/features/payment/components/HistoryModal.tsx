        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-4 border-b border-slate-100 flex items-center gap-2">
              <button className="flex-1 h-11 rounded-xl bg-slate-100 text-slate-500 flex items-center justify-center gap-2 text-sm font-bold">
                <Search size={16} /> 검색
              </button>
              <button className="w-11 h-11 rounded-xl bg-slate-100 text-slate-500 flex items-center justify-center">
                <Filter size={16} />
              </button>
            </div>
