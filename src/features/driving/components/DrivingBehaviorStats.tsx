...
export function DrivingBehaviorStats({ data }: { data: DailyDrivingData }) {
 ...
 key={i}
 className={`flex items-center gap-4 p-4 rounded-[32px] bg-white border-[0.5px] border-dashed ${item.border} group`}
 >
 ...
 <div className="text-lg font-black text-slate-900 drop-">
 {item.value}
 </div>
 </div>
 </motion.div>
