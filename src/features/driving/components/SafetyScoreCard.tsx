      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-5xl font-black text-slate-900">91</span>
        ...
        <div className="grid grid-cols-2 gap-4 mt-6">
          <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
            ...
            <div className="text-lg font-black text-slate-900">2,289 km</div>
          </div>
          <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
            <div className="text-[9px] text-slate-400 font-bold uppercase mb-0.5">누적 주행거리</div>
            <div className="text-lg font-black text-slate-900">127,993 km</div>
          </div>
        </div>
      </div>
