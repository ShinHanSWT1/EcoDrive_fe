...
export function MonthlyDrivingCard({
 ...
 viewport={{ once: true }}
 className="bg-white p-8 md:p-10 rounded-[50px] border-[0.5px] border-slate-100 relative overflow-hidden group mb-12"
 >
 ...
 <div>
 <div className="text-[10px] font-black uppercase tracking-widest mb-3 flex items-center gap-1.5 text-blue-600 bg-blue-50 border border-blue-100 w-fit px-3 py-1.5 rounded-xl ">
 ...
 <div className="flex flex-wrap items-center gap-2 text-[11px] font-bold mt-4 bg-slate-50 p-1.5 rounded-2xl w-fit border border-slate-100">
 {monthlyHistory.length > 1 ? (
 <>
 <span className="text-blue-600 flex items-center gap-1 bg-white px-3 py-1.5 rounded-xl ">
 최근 6개월 흐름 랭킹 <TrendingDown size={14} strokeWidth={3} />
 </span>
 <span className="text-slate-500 px-2">선택 월 기준 최근 6개월 데이터 집계</span>
 </>
 ) : (
 <span className="text-slate-500 bg-white px-4 py-2 rounded-xl ">
 {monthlySummaryData
 ...
 <div className="h-[240px] w-full relative z-10 bg-slate-50/50 backdrop-blur-sm rounded-[32px] p-6 border-[0.5px] border-dashed border-slate-200">
