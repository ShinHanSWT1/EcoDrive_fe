...
export function CarbonReductionEquivalenceCard({
 ...
 return (
 <div className="bg-white p-8 rounded-[40px] border-[0.5px] border-emerald-100 sm:p-10 relative overflow-hidden">
 ...
 <p className="text-sm text-slate-500 font-bold mt-2 bg-slate-50 px-4 py-2 rounded-full inline-block flex items-center gap-1 border border-slate-100">
 ...
 key={item.title}
 className={`rounded-[32px] bg-white border-[0.5px] ${item.borderColor} p-6 `}
 >
 ...
 <div className="mt-1 text-3xl font-black tracking-tight text-slate-900 drop-">
 {item.value}
 </div>
