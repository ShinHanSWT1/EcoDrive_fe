...
export function SafetyScoreCriteriaCard({
 ...
 return (
 <div className="bg-white p-8 rounded-[30px] border-[1px] border-slate-200 h-full shadow-sm">
 ...
 <span className="text-sm text-slate-500 font-black">산정 기간</span>
 <span className="text-sm font-black text-slate-900">
 {periodLabel ?? "--"}
 </span>
 </div>
 <div className="flex justify-between items-center py-4 border-b border-slate-100">
 <span className="text-sm text-slate-500 font-black">산정 기간 내 주행거리</span>
 <span className="text-sm font-black text-slate-900">
