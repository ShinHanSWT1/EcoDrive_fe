...
export function CarbonReductionCard() {
  return (
    <div className="bg-emerald-500 p-8 rounded-[32px] text-white shadow-lg shadow-emerald-100 relative overflow-hidden">
      ...
      <Leaf size={180} className="absolute -bottom-10 -right-10 text-white/10 -rotate-12" />
    </div>
  );
}
