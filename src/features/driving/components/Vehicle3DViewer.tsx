  ...
  return (
    <Html center>
      <div className="flex flex-col items-center justify-center text-slate-400 gap-3 whitespace-nowrap pointer-events-none">
        ...
        <span className="font-bold text-sm text-slate-700 bg-white/90 backdrop-blur px-5 py-2.5 rounded-full shadow-sm border border-slate-100">
          고사양 3D 모델 불러오는 중 ...
        </span>
      </div>
    </Html>
...
export function Vehicle3DViewer() {
  return (
    <div className="w-full h-[400px] md:h-[500px] bg-gradient-to-br from-[#f8fafc] to-[#e2e8f0] rounded-[40px] border-[5px] border-white shadow-xl shadow-slate-200/50 relative overflow-hidden my-8 cursor-grab active:cursor-grabbing">
      <div className="absolute top-6 left-6 z-10 bg-white/80 backdrop-blur-md px-4 py-2 rounded-2xl shadow-sm border border-white pointer-events-none">
