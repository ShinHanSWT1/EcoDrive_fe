    ...
    <section className="space-y-6 pt-8">
      <div className="flex justify-between items-center">
        <h3 className="font-black text-2xl flex items-center gap-2">
          <Sparkles className="text-[#FEE500]" fill="#FEE500" />
          마법같은 보험사 혜택 비교
        </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {companies.map((company, index) => (
          <motion.div
            ...
            className="bg-white p-8 rounded-[40px] shadow-[0_15px_40px_rgb(0,0,0,0.06)] flex flex-col justify-between cursor-pointer border-4 border-transparent hover:border-blue-100 transition-colors group relative overflow-hidden"
          >
            ...
            <div className="flex justify-between items-start mb-6 relative z-10">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-slate-50 rounded-[20px] flex items-center justify-center font-black text-2xl text-slate-700 shadow-inner group-hover:scale-110 transition-transform">
                  {company.logo}
                </div>
                <div>
              ...
              <div className="text-right">
                ...
                <div className="text-2xl font-black text-blue-600 drop-shadow-sm">
                  {formatPercent(company.discountRate)}
                </div>
              </div>
            </div>

            <div className="mb-6 p-4 bg-[#F8FAFC] rounded-3xl border-2 border-white shadow-sm flex items-center gap-2 relative z-10">
            ...
            <div className="pt-6 border-t-2 border-dashed border-slate-100 flex items-center justify-between relative z-10">
              <div className="space-y-1">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black text-white bg-red-500 px-1.5 py-0.5 rounded-lg shadow-sm">
                      -{formatPercent(company.discountRate)}
                    </span>
                  </div>
              ...
              <button className="w-12 h-12 bg-slate-900 text-white flex items-center justify-center hover:bg-blue-600 rounded-[20px] transition-colors shadow-lg group-hover:scale-110">
        ...
        {selectedCompany && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-[#F8FAFC] rounded-[50px] shadow-[0_20px_60px_rgb(0,0,0,0.15)] overflow-hidden flex flex-col max-h-[85vh] border-8 border-white"
            >
              <div className="p-8 pb-6 border-b-2 border-dashed border-slate-200 flex justify-between items-center bg-white relative z-10">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-slate-50 rounded-[24px] flex items-center justify-center font-black text-3xl shadow-inner text-slate-700">
              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-10 text-left bg-[#F8FAFC]">
                  ...
                  {[
                    ...
                    return (
                      <motion.button 
                        ...
                        className={`p-5 rounded-[32px] border-4 text-left transition-all shadow-sm ${
                          isSelected 
                            ? 'border-blue-600 bg-white ring-8 ring-blue-100/50 scale-105 z-10' 
                            : 'border-white bg-slate-50 hover:border-slate-200 opacity-60 hover:opacity-100'
                        }`}
                      >
                ...
                <div className="space-y-4">
                  <h5 className="font-black text-xl text-slate-900 flex items-center gap-2">
                    <ShieldCheck className="text-[#FEE500]" fill="#191600" size={28} />
                      ...
                      {coverages.map((cov, i) => {
                        ...
                        return (
                          <motion.div 
                            ...
                            key={cov.id} 
                            className={`p-5 rounded-[24px] flex justify-between items-center transition-all border-2 ${
                              isIncluded ? 'bg-white border-transparent shadow-sm' : 'bg-slate-100/50 border-transparent opacity-50 grayscale'
                            }`}
                          >
                            <div>
              ...
              <div className="p-6 bg-white flex gap-4 border-t-2 border-dashed border-slate-200">
                ...
                <button 
                  ...
                  className="flex-[2] py-5 bg-blue-600 text-white rounded-[28px] font-black shadow-[0_10px_30px_rgb(59,130,246,0.3)] hover:bg-blue-700 hover:-translate-y-1 transition-all text-lg"
                >
                  할인 듬뿍 받고 가입하기!
                </button>
              </div>
