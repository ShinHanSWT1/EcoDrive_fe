...
export default function InsuranceSummaryCard({
  ...
  return (
    <motion.div 
      ...
      className="w-full mx-auto rounded-[32px] border-4 border-[#222222] shadow-[0_20px_50px_rgb(0,0,0,0.15)] overflow-hidden relative bg-[#B3E1F7]"
    >
      <div className="text-right px-6 py-1.5 text-[11px] font-bold text-slate-800 tracking-wide font-sans relative z-10 opacity-70">
        www.shinhancard.com
      </div>
      <div className="w-full h-[60px] bg-[#1a1818] relative z-10 mb-6 shadow-inner" />

      <PawPrint size={40} className="absolute top-32 left-[20%] text-[#8bc8ea] opacity-40 -rotate-12 pointer-events-none" />
      <PawPrint size={30} className="absolute top-40 left-[10%] text-[#8bc8ea] opacity-40 rotate-12 pointer-events-none" />
      <PawPrint size={60} className="absolute bottom-20 right-[10%] text-[#8bc8ea] opacity-40 rotate-[30deg] pointer-events-none" />

      <div className="relative z-20 px-6 pb-8">
        
        <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl border-[3px] border-[#222222] flex justify-between items-center shadow-sm">
          <div>
        ...
        <div className="text-[10px] font-black text-[#222222] mt-1 tracking-tight px-2">서명(SIGNATURE)</div>

        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h4 className="text-sm font-black text-[#222222] flex items-center gap-2 bg-white/50 w-fit px-3 py-1.5 rounded-full">
              <CheckCircle2 size={18} className="text-emerald-600" />
              할인 조건 팡팡 현황
            </h4>

            <div className="space-y-3">
              <div className="flex justify-between items-center bg-white/70 backdrop-blur-sm p-4 rounded-3xl border-2 border-white shadow-sm">
                <span className="text-[13px] font-bold text-slate-700">안전 점수 80점 초과</span>
                <span className={`text-[10.5px] font-black px-2.5 py-1 rounded-xl shadow-sm ${
          ...
          <div className="md:col-span-2 bg-white rounded-[32px] p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 border-[3px] border-[#222222] shadow-[0_8px_0_rgba(34,34,34,1)] relative overflow-hidden">
            <div className="text-center md:text-left relative z-10 w-full">
              ...
              <div className="flex flex-wrap items-baseline justify-center md:justify-start gap-2">
                ...
                <span className="text-sm font-black text-blue-600 bg-blue-50 px-2 py-0.5 rounded-xl border border-blue-100 shadow-sm">
            ...
            <motion.button
              ...
              className="w-full md:w-auto bg-[#222222] text-white px-6 py-4 rounded-[20px] font-black shadow-lg hover:bg-black transition-all flex items-center justify-center gap-2 relative z-10 shrink-0 whitespace-nowrap"
            >
              산출서 리스트 오픈!
        ...
        <div className="flex justify-between items-end mt-10 pt-4 border-t-2 border-blue-400/30">
           <div className="flex gap-4">
              <div className="flex items-center gap-1 text-[13px] font-black text-[#0074B6] tracking-tight">
                <div className="w-5 h-5 bg-[#0074B6] rounded-full text-white flex items-center justify-center text-[10px] italic pr-0.5 pb-0.5 shadow-sm">S</div> 신한카드
              </div>
              <div className="flex items-center gap-1 text-[13px] font-black text-[#0074B6] tracking-tight">
                <div className="w-5 h-5 bg-[#0074B6] rounded-full text-white flex items-center justify-center text-[10px] italic pr-0.5 pb-0.5 shadow-sm">S</div> 신한은행
              </div>
           </div>
           <div className="text-[10px] font-bold text-[#0074B6] leading-snug hidden sm:block opacity-80">
